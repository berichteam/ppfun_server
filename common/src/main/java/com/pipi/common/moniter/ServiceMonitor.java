package com.pipi.common.moniter;

import com.pipi.common.exception.ServerInternalErrorException;
...
public class ServiceMonitor {
     ...
     * under that.
     */
    @Pointcut("execution(* com.pipi.common.service..*(..))")
     ...
     */
    @AfterThrowing(pointcut = "com.pipi.common.moniter.ServiceMonitor.serviceLayer()", throwing = "e")
